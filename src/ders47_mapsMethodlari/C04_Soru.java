...
public class C04_Soru {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < strArr.length ; i++) {
            ...
            //ele aldıgm element map'te varsa kullanim miktarini 1 artir.
            kullanimMiktarlariMap.computeIfPresent(strArr[i],(k,v)-> v+1);


            kullanimMiktarlariMap.putIfAbsent(strArr[i],1); // ele aldigim elemnt map'te yoksa kullanim miktari 1 olarak map'e ekleyecegim.
        }

        System.out.println(kullanimMiktarlariMap); // { =3, J=1, a=7, b=2, d=1, e=1, i=4, l=3, m=2, n=2, o=1, p=1, r=1, t=3, u=1, v=1, y=1}
    }
